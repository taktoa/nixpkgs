...
, freetype, fribidi
, encaSupport ? false, enca ? null # enca support
, fontconfigSupport ? false, fontconfig ? null # fontconfig support
, harfbuzzSupport ? false, harfbuzz ? null # harfbuzz support
